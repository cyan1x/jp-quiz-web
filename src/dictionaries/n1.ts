...
export const n1: QuizDeck = [
  ...
  },
  {
    ...
    answer: ["いきさつ", "けいい"],
    meaning:
      "details, whole story, sequence of events, particulars, how it started, how things got this way",
  },
  {
    question: "異議",
    answer: ["いぎ"],
  ...
  },
  {
    ...
    answer: ["うるおう"],
    meaning:
      "to be moist, to be damp, to get wet, to profit by, to be watered, to receive benefits, to favor, to charm",
  },
  {
    question: "植わる",
    answer: ["うわる"],
  ...
  },
  {
    ...
    answer: ["おつ", "きのと"],
    meaning:
      "1. strange, quaint, stylish, chic, spicy, queer, witty, tasty, romantic, 2. 2nd in rank, second sign of the Chinese calendar​",
  },
  {
    question: "衰える",
    answer: ["おとろえる"],
  ...
  },
  {
    ...
    answer: ["かかげる"],
    meaning:
      "to publish, to print, to carry (an article), to put up, to hang out, to hoist, to fly (a sail)",
  },
  {
    question: "課外",
    answer: ["かがい"],
  ...
  },
  {
    ...
    answer: ["かたむける"],
    meaning:
      "to incline, to list, to bend, to lean, to tip, to tilt, to slant, to concentrate on, to ruin (a country)",
  },
  {
    question: "固める",
    answer: ["かためる"],
  ...
  },
  {
    ...
    answer: ["かん", "かんむり"],
    meaning:
      "crown, diadem, first, best, peerless, cap, naming, designating, initiating on coming of age",
  },
  {
    question: "簡易",
    answer: ["かんい"],
  ...
  },
  {
    ...
    answer: ["きのえ", "こう"],
    meaning:
      "1st in rank, first sign of the Chinese calendar, shell, instep, grade A (きのえ); carapace, shell (こう)",
  },
  {
    question: "規範",
    answer: ["きはん"],
  ...
  },
  {
    ...
    answer: ["かさなる", "おもなる"],
    meaning:
      "to be piled up; to lie on top of one another, to come one after another; to happen over and over; to pile up (e.g. stress); to accumulate, to overlap (each other)",
  },
  {
    question: "恋する",
    answer: ["こいする"],
  ...
  },
  {
    ...
    answer: ["こう", "みぞ", "どぶ"],
    meaning:
      "10^38, hundred undecillion, hundred sextillion (こう), ditch, drain, gutter, trench (みぞ)",
  },
  {
    question: "行為",
    answer: ["こうい"],
  ...
  {
    question: "堪える",
    answer: ["こらえる", "たえる", "こたえる"],
    meaning:
      "to bear, to stand, to endure, to put up with, to support, to withstand, to resist, to brave, to be fit for",
  },
  {
    question: "誇張",
    answer: ["こちょう"],
  ...
  },
  {
    ...
    answer: ["こまやか", "ささやか"],
    meaning:
      "tender; warm; caring; thoughtful​ (こまやか) meager; modest (ささやか)",
  },
  {
    question: "混む",
    answer: ["こむ"],
  ...
  },
  {
    ...
    answer: ["つらねる"],
    meaning:
      "to line up; to put in a row, to add (to a group); to accept (as a member of an organization, etc.); to join (e.g. a list), to link; to put together; to string together (e.g. compliments)",
  },
  {
    question: "差異",
    answer: ["さい"],
  ...
  },
  {
    ...
    answer: ["さいせい"],
    meaning:
      "playback, regeneration, resuscitation, return to life, rebirth, reincarnation, narrow escape, reclamation",
  },
  {
    question: "最善",
    answer: ["さいぜん"],
  ...
  },
  {
    ...
    answer: ["つらなる"],
    meaning:
      "to extend; to stretch out; to stand in a row, to attend; to participate in, to enrol; to join, to have a connection; to be related; to be linked",
  },
  {
    question: "差額",
    answer: ["さがく"],
  ...
  },
  {
    ...
    answer: ["しぶい"],
    meaning:
      "1. tasteful (clothing), cool, an aura of refined masculinity, 2. astringent, sullen, bitter (taste)",
  },
  {
    question: "司法",
    answer: ["しほう"],
  ...
  },
  {
    ...
    answer: ["あなた"],
    meaning:
      "your home; your residence, you (referring to one's equal; epistolary style), you (referring to someone of equal or lower status), dear (what a wife calls a husband)",
  },
  {
    question: "繕う",
    answer: ["つくろう"],
  ...
  },
  {
    ...
    answer: ["むほん"],
    meaning:
      "rebellion; uprising; insurrection, treason, plotting to overthrow the government (by assassinating the emperor)",
  },
  {
    question: "釣鐘",
    answer: ["つりがね"],
  ...
  },
  {
    ...
    answer: ["めす"],
    meaning:
      "to call, to send for, to put on, to wear, to take (a bath), to ride in, to buy, to eat, to drink",
  },
  {
    question: "雌",
    answer: ["めす"],
  ...
  },
  {
    ...
    answer: ["もよおす"],
    meaning:
      "to hold (a meeting), to give (a dinner), to feel, to show signs of, to develop symptoms of",
  },
  {
    question: "漏らす",
    answer: ["もらす"],
  ...
  },
  {
    ...
    answer: ["にしび"],
    meaning:
      "westering sun; setting sun, Spanish-Japanese (gen. for translations and dictionaries)",
  },
  {
    question: "裾",
    answer: ["すそ"],
    meaning:
      "hem; (trouser) cuff; shirttail, bottom edge, foot (of a mountain), tips (of hair), downstream",
  },
  {
    question: "蜂蜜",
    answer: ["はちみつ"],
  ...
  },
  {
    ...
    answer: ["なえる"],
    meaning:
      "to lose strength; to become weak; to waste away, to wither; to droop",
  },
  {
    question: "苛める",
    answer: ["いじめる"],
  ...
  },
  {
    ...
    answer: ["みずから", "おのずから"],
    meaning:
      "naturally; as a matter of course, oneself, for one's self; personally",
  },
  {
    question: "臆病",
    answer: ["おくびょう"],
  ...
  },
  {
    ...
    answer: ["もも", "また"],
    meaning:
      "crotch; crutch; groin; thigh, fork (in a tree, road, river, etc.); tines (of a fork), thigh, femoral",
  },
  {
    question: "考古学",
    answer: ["こうこがく"],
  ...
  {
    question: "縁",
    answer: ["えん", "ゆかり", "ふち", "へり", "えにし"],
    meaning:
      "related to (some person or place); affinity; connection, fate; destiny (esp. as a mysterious force that binds two people together), relationship (e.g. between two people)",
  },
  {
    question: "綻びる",
    answer: ["ほころびる"],
  ...
  },
  {
    ...
    answer: ["せつ", "ふし"],
    meaning:
      "occasion; time, section (of a literary work); paragraph; verse; stanza; passage, principle; integrity, node (of a plant stem), clause, (taxonomical) section, knot (nautical mile per hour), joint",
  },
  {
    question: "空ろ",
    answer: ["うつろ"],
    meaning:
      "cavity; hollow; void, hollow (voice); empty (heart); blank (eyes, face, etc.); vacant (stare)",
  },
  {
    question: "片仮名",
    answer: ["かたかな"],
  ...
  },
  {
    ...
    answer: ["すぐ"],
    meaning:
      "immediately; at once; directly, soon; before long; shortly, easily; readily; without difficulty, right (near); nearby; just (handy), honest; upright; frank; straightforward",
  },
  {
    question: "目論見",
    answer: ["もくろみ"],
  ...
  },
  {
    ...
    answer: ["やまい"],
    meaning:
      "illness; disease, bad habit; weakness; fault, pain; trouble, illness, disease; -pathy",
  },
  {
    question: "休養",
    answer: ["きゅうよう"],
  ...
  },
  {
    ...
    answer: ["おろそか"],
    meaning:
      "negligent; neglectful; careless; remiss, not to mention ...; needless to say ...; not to speak of ...; not only ..., negligent; neglectful; careless; remiss",
  },
  {
    question: "畳",
    answer: ["たたみ", "じょう"],
    meaning:
      "counter for tatami mats, measure of room size (in mat units), tatami mat; Japanese straw floor coverings, folding paper-case; kimono wrapping paper",
  },
  {
    question: "砕く",
    answer: ["くだく"],
  ...
  },
  {
    ...
    answer: ["こうおつ"],
    meaning:
      "A and B; excellent and good; similarity, discrimination; discernment; distinction, first and second parties (in legal contexts)",
  },
  {
    question: "田園",
    answer: ["でんえん"],
  ...
  },
  {
    ...
    answer: ["しずく"],
    meaning:
      "drop (of water); drip, dripping; drop, counter for drops of liquid",
  },
  {
    question: "酸性",
    answer: ["さんせい"],
  ...
  },
  {
    ...
    answer: ["きふう"],
    meaning:
      "character; traits; ethos, character; disposition; spirit; temperament",
  },
  {
    question: "食器",
    answer: ["しょっき"],
  ...
  },
  {
    ...
    answer: ["まさに"],
    meaning:
      "exactly; surely; certainly, right then; just then; at that moment, just (about to); on the verge (of doing or happening), duly; naturally",
  },
  {
    question: "棄てる",
    answer: ["すてる"],
  ...
  },
  {
    ...
    answer: ["さく", "しがらみ"],
    meaning:
      "fence; paling; railing, weir, bonds; fetters; ties of obligation, fortress (surrounded by a wall, moat, etc.)",
  },
  {
    question: "柳眉",
    answer: ["りゅうび"],
  ...
  },
  {
    ...
    answer: ["それる", "はぐれる"],
    meaning:
      "to stray (turn) from subject, to get lost, to go astray (それる); to lose sight of (one's companions); to stray from​ (はぐれる)",
  },
  {
    question: "算盤",
    answer: ["そろばん"],
  ...
  },
  {
    ...
    answer: ["もめん"],
    meaning:
      "cotton (material), red silk-cotton tree (Bombax ceiba), string made of cut steamed, soaked mulberry bark fibers",
  },
  {
    question: "朝寝坊",
    answer: ["あさねぼう"],
  ...
  },
  {
    ...
    answer: ["きょく"],
    meaning:
      "song; tune; composition; piece of music, corner; nook; recess, a shadow; a shade, wickedness; evil; calamity; disaster, long segment of a noh play forming its musical highlight, wrong",
  },
  {
    question: "暗殺",
    answer: ["あんさつ"],
  ...
  {
    question: "斑",
    answer: ["ハン", "まだら", "むら", "ぶち", "ふ"],
    meaning:
      "uneven; irregular; speckled; mottled, erratic; inconsistent, fickle; capricious; fitful, spots; speckles; mottles, spots; speckles; mottles, speckled; spotted",
  },
  {
    question: "敢えて",
    answer: ["あえて"],
    meaning:
      "purposely (of something needless, unexpected or seemingly counterproductive, etc.); daringly (doing something); deliberately; intentionally, not necessarily; not particularly",
  },
  {
    question: "伝染",
    answer: ["でんせん"],
  ...
  },
  {
    ...
    answer: ["ほうりだす"],
    meaning:
      "to throw out, to drop; to toss; to dump, to abandon; to neglect; to leave behind; to give up, to dismiss; to fire; to expel, to expel; to eject; to push out; to force out",
  },
  {
    question: "峠",
    answer: ["とうげ"],
  ...
  },
  {
    ...
    answer: ["いくさ"],
    meaning:
      "war; battle; campaign; fight, troops; forces, war; battle, match; competition",
  },
  {
    question: "成る丈",
    answer: ["なるたけ", "なるだけ"],
  ...
  },
  {
    ...
    answer: ["おもわく", "しわく"],
    meaning:
      "expectation; anticipation; prediction; forecast; calculations, purpose; intention; motive; ulterior motive, others' opinions of one, speculation, perceptive mental disturbances",
  },
  {
    question: "民謡",
    answer: ["みんよう"],
  ...
  {
    question: "彼方",
    answer: ["かなた", "あなた", "あちら", "あっち"],
    meaning:
      "beyond; across; the other side; the distance, that way (direction distant from both speaker and listener); over there; yonder, that one (something physically distant from both speaker and listener, or something not visible but known by both speaker and listener)",
  },
  {
    question: "要旨",
    answer: ["ようし"],
  ...
  },
  {
    ...
    answer: ["たけ", "じょう"],
    meaning:
      "height; stature, length (esp. of clothing), all (one has); everything, magnificence (of a waka poem, etc.), 3.03 meters (ten shaku), length; measure, Mr.; Mrs.",
  },
  {
    question: "三日月",
    answer: ["みかづき"],
  ...
  },
  {
    ...
    answer: ["おおやけ"],
    meaning:
      "public; open; formal; official; governmental, public matter; governmental matter",
  },
  {
    question: "共鳴",
    answer: ["きょうめい"],
  ...
  },
  {
    ...
    answer: ["ばける"],
    meaning:
      "to take the form of (esp. in ref. to a spirit, fox, raccoon dog, etc.); to assume the shape of; to turn oneself into; to transform oneself into, to disguise oneself as, to change radically",
  },
  {
    question: "危ぶむ",
    answer: ["あやぶむ"],
  ...
  },
  {
    ...
    answer: ["もと", "もとい"],
    meaning:
      "origin; source, base; basis; foundation; root, cause, ingredient; material, original cost (or capital, principal, etc.), (plant) root; (tree) trunk, first section of a waka, handle (chopsticks, brush, etc.)",
  },
  {
    question: "声高",
    answer: ["こわだか"],
  ...
  },
  {
    ...
    answer: ["としごろ"],
    meaning:
      "approximate age; apparent age, marriageable age (esp. of a woman); age of maturity; age of adulthood, appropriate age (to ...); old enough (to ...), past few years",
  },
  {
    question: "幾多",
    answer: ["いくた"],
  ...
  },
  {
    ...
    answer: ["まずい"],
    meaning:
      "unappetising; unappetizing; unsavoury; unsavory; unpleasant; unskillful; unskilful; bungling; clumsy; poor; ugly; unattractive; homely; plain; awkward; problematic",
  },
  {
    question: "不良",
    answer: ["ふりょう"],
  ...
  },
  {
    ...
    answer: ["しまう"],
    meaning:
      "to finish; to stop; to end; to put an end to; to bring to a close; to close (a business, etc.); to close down; to shut down; to shut up; to put away; to put back",
  },
  {
    question: "代わる代わる",
    answer: ["かわるがわる"],
  ...
  },
  {
    ...
    answer: ["はげる"],
    meaning:
      "to come off; to be worn off; to fade; to discolor; to discolour; to peel off",
  },
  {
    question: "割合に",
    answer: ["わりあいに"],
  ...
  },
  {
    ...
    answer: ["まちまち", "くく"],
    meaning:
      "petty; trivial; insignificant; trifling; several; various; divergent; conflicting; different; diverse",
  },
  {
    question: "単一",
    answer: ["たんいつ", "たんいち"],
  ...
  },
  {
    ...
    answer: ["そり"],
    meaning:
      "warp; curvature; curve; arch; turning over; flipping over; reply; response; marks indicating the Japanese meaning of the texts of Chinese classics; lapel",
  },
  {
    question: "収まる",
    answer: ["おさまる"],
  ...
  },
  {
    ...
    answer: ["はく"],
    meaning:
      "to breathe out; to breathe; to tell (a lie); to use (foul language); to vomit; to throw up; to spit up; to vomit; to throw up; to spit up; to emit; to send forth",
  },
  {
    question: "君主",
    answer: ["くんしゅ"],
  ...
  {
    question: "夜中",
    answer: ["よなか", "よじゅう", "やちゅう"],
    meaning:
      "middle of the night; dead of night; during the night; at night; all night; the whole night",
  },
  {
    question: "夜更け",
    answer: ["よふけ"],
  ...
  },
  {
    ...
    answer: ["いい", "よい"],
    meaning:
      "good; excellent; fine; nice; pleasant; agreeable; sufficient (can be used to turn down an offer); ready; prepared; profitable (e.g. deal, business offer, etc.); beneficial",
  },
  {
    question: "姉妹",
    answer: ["しまい", "きょうだい"],
  ...
  },
  {
    ...
    answer: ["ゆか", "とこ"],
    meaning:
      'bed; bedding; sickbed; alcove; riverbed; seedbed; straw "core" of a tatami mat; floor; floor; stage (for the narrator and the shamisen player); dining platform built across a river',
  },
  {
    question: "弾",
    answer: ["たま"],
    meaning:
      "ball; sphere; globe; orb; bead (of sweat, dew, etc.); drop; droplet; ball (in sports); pile (of noodles, etc.); bullet; bulb (i.e. a light bulb); lens (of glasses, etc.)",
  },
  {
    question: "弾く",
    answer: ["ひく", "はじく"],
    meaning:
      "to flip; to snap; to flick; to repel; to use (an abacus); to calculate; to strum; to pluck the strings (of a guitar, etc.); to play (piano, guitar)",
  },
  {
    question: "役場",
    answer: ["やくば"],
  ...
  },
  {
    ...
    answer: ["とほ"],
    meaning:
      "walking; going on foot; foot soldier (Edo period); samurai on foot; going on foot; walking",
  },
  {
    question: "心地",
    answer: ["ここち"],
    meaning:
      "feeling; sensation; mood; sensation of doing (usu. after -masu stem of verb); padding; lining; foundation",
  },
  {
    question: "必至",
    answer: ["ひっし"],
  ...
  },
  {
    ...
    answer: ["ハイ", "さかずき"],
    meaning:
      "sake cup; cup for alcoholic beverages; sake cup; cup for alcoholic beverages; counter for cupfuls; counter for ships, octopuses and squid; shallow bowl",
  },
  {
    question: "果たす",
    answer: ["はたす"],
  ...
  },
  {
    ...
    answer: ["かまえる"],
    meaning:
      "to set up (a house, store, etc.); to build; to establish; to run; to maintain; to have at the ready (e.g. a gun); to hold in preparation (e.g. a camera); to prepare in advance (e.g. a meal)",
  },
  {
    question: "様式",
    answer: ["ようしき"],
  ...
  {
    question: "灯",
    answer: ["ともしび", "ひ", "あかし", "あかり"],
    meaning:
      "light; lamp; torch; lamp; light; light (esp. as a religious offering); lamp; light; lamp; counter for electric lights; light; lamp; baiting deer with a lighted torch",
  },
  {
    question: "灰",
    answer: ["はい"],
  ...
  },
  {
    ...
    answer: ["むくち"],
    meaning:
      "reticence; taciturnity; silent person; reticent; taciturn; silent; astomatous",
  },
  {
    question: "無茶苦茶",
    answer: ["むちゃくちゃ"],
    meaning:
      "nonsensical; unreasonable; absurd; unrealistic; awfully; extremely; to excess; senseless; reckless; disorder; confusion; being jumbled; being mixed up; very; extremely",
  },
  {
    question: "無論",
    answer: ["むろん"],
  ...
  },
  {
    ...
    answer: ["あまい", "うまい"],
    meaning:
      "sweet-tasting; sweet; sugary; sugared; fragrant (smelling); sweet (music); lightly salted; light in salt; not spicy; naive; overly optimistic; soft on; generous",
  },
  {
    question: "生身",
    answer: ["なまみ"],
  ...
  },
  {
    ...
    answer: ["さかる", "もる"],
    meaning:
      "to prosper; to flourish; to copulate (animals); to serve (food, etc.); to dish out; to fill up; to pile up; to heap; to prescribe; to administer; to dose out; to put into (e.g. information in a report)",
  },
  {
    question: "目方",
    answer: ["めかた"],
  ...
  },
  {
    ...
    answer: ["など", "とう"],
    meaning:
      "et cetera; etc.; and the like; and so forth; or something; the likes of; class; order; rank; et cetera; etc.; and the like; equal; iso-; pluralizing suffix; or so",
  },
  {
    question: "経費",
    answer: ["けいひ"],
  ...
  },
  {
    ...
    answer: ["かど", "つの", "かく"],
    meaning:
      'angle; square (or cube); bishop; third degree (of the Japanese & Chinese pentatonic scale); Chinese "horn" constellation (one of the 28 mansions); jiao (monetary unit of China)',
  },
  {
    question: "試み",
    answer: ["こころみ"],
  ...
  {
    question: "退く",
    answer: ["どく", "のく", "ひく", "しりぞく"],
    meaning:
      "to step aside; to move (i.e. out of the way); to make way; to resign; to retire; to quit; to secede; to step back; to move back; to retreat; to withdraw (from the presence of a superior)",
  },
  {
    question: "退ける",
    answer: ["どける", "のける", "しりぞける"],
    meaning:
      "to repel; to drive away; to repulse; to reject; to put something out of the way; to move (something, someone) aside; to set aside; to keep apart; to remove (someone) from the group",
  },
  {
    question: "逃す",
    answer: ["のがす"],
  ...
  },
  {
    ...
    answer: ["つくる"],
    meaning:
      "to make; to produce; to manufacture; to build; to construct; to prepare (food); to brew (alcohol); to raise; to grow; to cultivate; to train; to till; to draw up (a document)",
  },
  {
    question: "遅らす",
    answer: ["おくらす"],
  ...
  },
  {
    ...
    answer: ["きんこ", "かねぐら"],
    meaning:
      "safe; strongbox; cashbox; vault; strongroom; depository; cash office; treasury; provider of funds; treasure house; treasury; financial supporter; patron; financier",
  },
  {
    question: "釣り",
    answer: ["つり"],
  ...
  },
  {
    ...
    answer: ["かみなり", "いかずち"],
    meaning:
      "lightning; thunder; thunderbolt; god of thunder; god of lightning; anger; fit of anger; thunder",
  },
  {
    question: "頑丈",
    answer: ["がんじょう"],
  ...
  },
  {
    ...
    answer: ["ほね", "こつ"],
    meaning:
      "knack; skill; trick; secret; know-how; the ropes; hang; bone; frame; outline; core; backbone; spirit; fortitude; laborious; troublesome; difficult",
  },
  {
    question: "遂に",
    answer: ["ついに"],
  ...
  },
  {
    ...
    answer: ["こくめい"],
    meaning:
      "detailed; elaborate; faithful (copy); accurate; scrupulous; diligent; conscientious",
  },
  {
    question: "渋る",
    answer: ["しぶる"],
  ...
  },
  {
    ...
    answer: ["ほのお"],
    meaning:
      "flame; blaze, flames (of intense emotion, e.g. love, jealousy, anger); passion, -itis (indicating an inflammatory disease)",
  },
  {
    question: "激しい",
    answer: ["はげしい"],
  ...
  },
  {
    ...
    answer: ["しだい"],
    meaning:
      "depending on, as soon as; immediately (upon), in accordance with, order; program; programme; precedence, circumstances; course of events; reason",
  },
  {
    question: "欠陥",
    answer: ["けっかん"],
  ...
  },
  {
    ...
    answer: ["もよう"],
    meaning:
      "pattern; figure; design, state; condition, conjecture of the current situation; the way it seems, model; pattern; example, indicates that that noun seems likely (e.g. rain or storm), framework (in go)",
  },
  {
    question: "検討",
    answer: ["けんとう"],
  ...
  },
  {
    ...
    answer: ["むすぶ"],
    meaning:
      "to tie; to bind; to link, to bear (fruit), to close (e.g. deal); to confirm; to conclude, to connect (two distant places), to close tightly; to purse (e.g. lips), to unite (with)",
  },
  {
    question: "株",
    answer: ["かぶ"],
  ...
  },
  {
    ...
    answer: ["ほお", "ほほ"],
    meaning:
      "cheek (of face), face; mug, surface, surrounding area, cheek; cheeks",
  },
]
