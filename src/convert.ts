// https://github.com/mistval/kotoba/blob/master/bot/src/common/util/convert_to_hiragana.js

type genericDictionary = { [key: string]: string }

const lengthenerForChar: genericDictionary = {
  あ: "あ",
  い: "い",
  う: "う",
  え: "い",
...
const hiraganaForRomaji: genericDictionary = {
  a: "あ",
  i: "い",
  u: "う",
  e: "え",
...
export function convertStringToHiragana(str: string): string {
